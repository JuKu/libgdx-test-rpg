 ...
 */
public class MultiplayerGameScreen extends BaseScreen {
    ...
    public void onResume () {
        ...
        if (this.client == null) {
            throw new NullPointerException("network client cannot be null.");
        }
        ...
        //create campfire
        Entity campfireEntity = AnimatedEnvObjectFactory
            .createBasicAnimatedLightingEntity(this.ecs, this.campfireTexture, this.lightMap, 300, 300, 150, 1, 5);
